...
- Знание пользователей и прав ([[./02-users-groups-permissions.md|Users and Permissions]])
...
Следующий шаг:
- [[./04-package-management-overview.md|Package Management]] — установка ПО

Предыдущий шаг:
- [[./02-users-groups-permissions.md|Users and Permissions]] — управление доступом
