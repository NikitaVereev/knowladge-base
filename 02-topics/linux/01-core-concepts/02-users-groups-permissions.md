...
Следующий шаг:
- [[./03-processes-and-services.md|Processes and Services]] — управление процессами и сервисами

Предыдущий шаг:
- [[./01-filesystem-hierarchy.md|Filesystem Hierarchy]] — структура файловой системы
