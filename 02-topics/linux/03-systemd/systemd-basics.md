...
### ← Перед этим (опционально)
- [[linux-package-managers]] - выбор дистро (systemd везде)
- [[arch-maintenance-guide]] - как применять в Arch

### → Логическое продолжение (продвинутое)
- [[systemd-guide-extended]] - создание service файлов, таймеры

### ↔ Применение
- [[linux-backup-strategy]] - таймеры для автоматизации backup'ов
- [[arch-troubleshooting-guide]] - диагностика сервисов
