...
### 1. Installation
**[01-installation.md](./01-installation.md)** | Type: **Tutorial**
...
### 4. Maintenance
**[04-maintenance.md](./04-maintenance.md)** | Type: **How-to**
...
### 5. Troubleshooting
**[05-troubleshooting.md](./05-troubleshooting.md)** | Type: **Reference**
...
Следующие шаги:
- [[../README.md|Distro-Specific Index]] — другие дистрибутивы (Ubuntu и т.д.)
