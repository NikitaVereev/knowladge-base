...
- Понимание что такое дистрибутив ([[./02-distributions-guide.md|Choosing a Distribution]])
...
Следующий шаг:
- [[../01-core-concepts/README.md|Core Concepts]] — фундаментальные знания о Linux

Предыдущий раздел:
- [[./02-distributions-guide.md|Choosing a Distribution]] — как выбрать дистрибутив
