...
После этого раздела вы будете готовы перейти к [[../01-core-concepts/README.md|Core Concepts]].

## RELATED

Связанные разделы после этого:
- [[../01-core-concepts/README.md|Core Concepts]] — фундаментальные знания о файлах, правах, процессах
