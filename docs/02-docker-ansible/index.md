...
- [03-docker-basics/](docs/02-docker-ansible/03-docker-basics/index.md) — контейнеры, архитектура Docker, жизненный цикл контейнера, базовые команды, логи и отладка.
- [04-docker-images-dockerfile/](docs/02-docker-ansible/04-docker-images-dockerfile/index.md) — образы, слои, Dockerfile, сборка и оптимизация образов.
