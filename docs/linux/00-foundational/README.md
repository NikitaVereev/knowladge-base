...
После этого раздела вы будете готовы перейти к [[docs/linux/01-core-concepts/README|Core Concepts]].

## RELATED

Связанные разделы после этого:
- [[docs/linux/01-core-concepts/README|Core Concepts]] — фундаментальные знания о файлах, правах, процессах
- [[docs/linux/02-distro-specific/README|Distro-Specific]] — углубленные инструкции для вашего дистрибутива

Контекст:
- [[docs/linux/README|Main documentation]] — полный каталог всей документации
