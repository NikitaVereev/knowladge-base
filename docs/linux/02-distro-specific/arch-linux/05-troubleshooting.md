...
- [[docs/linux/02-distro-specific/arch-linux/01-installation|Installation]] — если нужна переустановка
- [[docs/linux/02-distro-specific/arch-linux/04-maintenance|Maintenance]] — профилактика
- [[docs/linux/02-distro-specific/README|Arch Index]] — индекс
