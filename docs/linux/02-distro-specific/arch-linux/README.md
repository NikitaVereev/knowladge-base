...
### 1. Installation
**[01-installation.md](docs/linux/02-distro-specific/arch-linux/01-installation.md)** | Type: **Tutorial**
...
### 4. Maintenance
**[04-maintenance.md](docs/linux/02-distro-specific/arch-linux/04-maintenance.md)** | Type: **How-to**
...
### 5. Troubleshooting
**[05-troubleshooting.md](docs/linux/02-distro-specific/arch-linux/05-troubleshooting.md)** | Type: **Reference**
...
Следующие шаги:
- [[docs/linux/02-distro-specific/README|Distro-Specific Index]] — другие дистрибутивы (Ubuntu и т.д.)
- [[docs/linux/03-system-administration/README|System Administration]] — администрирование сервера

Предыдущие разделы:
- [[docs/linux/01-core-concepts/README|Core Concepts]] — основные концепции Linux
- [[docs/linux/00-foundational/README|Foundational]] — основы Linux
