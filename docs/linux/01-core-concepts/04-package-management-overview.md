...
Следующие шаги:
- [[docs/linux/02-distro-specific/README|Distro-Specific]] — углубленные инструкции для дистрибутива
- [[docs/linux/03-system-administration/README|System Administration]] — администрирование
