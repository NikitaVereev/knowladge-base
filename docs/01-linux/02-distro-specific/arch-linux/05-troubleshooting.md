...
- [[docs/01-linux/02-distro-specific/arch-linux/01-installation|Installation]] — если нужна переустановка
- [[docs/01-linux/02-distro-specific/arch-linux/04-maintenance|Maintenance]] — профилактика
