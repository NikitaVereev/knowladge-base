...
- [[docs/01-linux/02-distro-specific/arch-linux/04-maintenance|Maintenance]] — обслуживание системы
- [[docs/01-linux/02-distro-specific/README|Arch Index]] — полный индекс
