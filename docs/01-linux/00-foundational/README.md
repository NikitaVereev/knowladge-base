...
После этого раздела вы будете готовы перейти к [[docs/01-linux/01-core-concepts/README|Core Concepts]].

## RELATED

Связанные разделы после этого:
- [[docs/01-linux/01-core-concepts/README|Core Concepts]] — фундаментальные знания о файлах, правах, процессах
- [[docs/01-linux/02-distro-specific/README|Distro-Specific]] — углубленные инструкции для вашего дистрибутива

Контекст:
- [[docs/01-linux/index|Main documentation]] — полный каталог всей документации
