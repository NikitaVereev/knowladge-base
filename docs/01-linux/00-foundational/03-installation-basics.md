...
Следующий шаг:
- [[docs/01-linux/01-core-concepts/README|Core Concepts]] — фундаментальные знания о Linux

Предыдущий раздел:
- [[02-distributions-guide|Choosing a Distribution]] — как выбрать дистрибутив

Контекст:
- [[docs/01-linux/00-foundational/README|Foundational Index]] — полный индекс этого раздела
