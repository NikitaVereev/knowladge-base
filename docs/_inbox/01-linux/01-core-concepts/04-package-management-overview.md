...
Следующие шаги:
- [[docs/_inbox/01-linux/02-distro-specific/README|Distro-Specific]] — углубленные инструкции для дистрибутива
- [[docs/_inbox/01-linux/03-system-administration/README|System Administration]] — администрирование
