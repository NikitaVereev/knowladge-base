...
*   Установленный Docker Engine (см. [[devops/docker/how-to/1-install-docker|1-install-docker]]).
...
Перейти к уроку: [[devops/k8s/tutorials/2-first-pod|2. Первый Pod (Manifests, Kubectl run)]]
