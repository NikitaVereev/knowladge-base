---
title: "6 Настройка Healthchecks"
description: "Автоматическое восстановление сервисов (Self-Healing)."
---
...
## Связанные материалы
- [[devops/docker/how-to/health-monitoring|Основы Docker Healthchecks]]
- [[1-deploy-stack|Развертывание стеков]]
