...
prev: "[[docker/tutorials/04-networking-workshop]]"
next: "[[docker/tutorials/06-swarm-cluster]]"
---

#  Отладка контейнеров

> **Цель:** Научиться находить и чинить 3 типа проблем: падающий контейнер,
> сетевая недоступность, потерянные файлы. Практика на сломанных примерах.
