---
title: Модель дистрибуции (Registry)
type: explanation
tags: [docker, registry, oci, distribution, manifest, digest, tags, ghcr]
sources:
  docs: "https://docs.docker.com/registry/"
related:
  - "[[docker/how-to/private-registry]]"
...
> **TL;DR:** Registry хранит образы как слои (blobs) + манифесты (JSON). Тег — мутабельная ссылка,
> дайджест (SHA256) — иммутабельная. Multi-arch работает через Manifest Lists.
