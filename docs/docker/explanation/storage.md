...
related:
  ...
  - "[[docker/how-to/cleanup-maintenance]]"
  - "[[docker/tutorials/03-compose-app]]"
---

# Модель хранения данных в Docker

> **TL;DR:** Данные в контейнере — эфемерны. Для персистентности: Volumes (production),
> Bind Mounts (разработка), tmpfs (секреты/кэш в RAM).
